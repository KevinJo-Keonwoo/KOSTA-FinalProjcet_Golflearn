$(function () {
		...
		success: function (jsonObj) {
			...
			$("div.viewlesson>div.viewlesson-img>img")
				.attr("src", "../lsn_images/" + queryString + "_LessonThumbnail.jpg")
				.attr("alt", lsn_title);
			...
			$(lessonLines).each(function (i, element) {
				...
				let lessonReview = "<ul>";
				lessonReview +=
					'<li><div>작성자아이디: <span class = "reviewId">' +
					reviewNickname +
					"</span></div></li>";
				lessonReview +=
					'<li><div>작성날짜: <span class = "reviewDt">' +
					reviewDt +
					"</span></div></li>";
				lessonReview +=
					'<li><div>리뷰: <span class = "review">' +
					review +
					"</span></div></li>";
				lessonReview += "</ul>";
